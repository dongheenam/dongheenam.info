...
\begin{align*}
\dfrac{1}{\sqrt{7}-\sqrt{6}} &= \dfrac{1 \hl{ \times (\sqrt{7}+\sqrt{6}) }}{(\sqrt{7}-\sqrt{6})\hl{ \times (\sqrt{7}+\sqrt{6}) }} \cr
&= \dfrac{\sqrt{7}+\sqrt{6}}{(\sqrt{7})^2 - (\sqrt{6})^2} \cr
&= \dfrac{\sqrt{7}+\sqrt{6}}{7-6} \cr
&= \sqrt{7}+\sqrt{6}.
\end{align*}
...
\begin{align*}
\dfrac{\sqrt{2}}{\sqrt{2} + 3} &= \dfrac{\sqrt{2}\hl{\times (3-\sqrt{2})}}{(\sqrt{2} + 3)\hl{\times (3-\sqrt{2})}} \cr
&= \frac{\sqrt{2}(3-\sqrt{2})}{3^2 - (\sqrt{2})^2} \cr
&= \frac{3\sqrt{2} - 2}{9 - 2} \cr
...
\begin{align*}
& \dfrac{\sqrt{5}}{\sqrt{3}+1} - \dfrac{\sqrt{3}}{\sqrt{5}+\sqrt{3}} \cr
&= \dfrac{\sqrt{5}\hl{\times (\sqrt{3}-1)}}{(\sqrt{3}+1)\hl{\times (\sqrt{3}-1)}} - \dfrac{\sqrt{3}\hl{\times (\sqrt{5}-\sqrt{3})}}{(\sqrt{5}+\sqrt{3})\hl{\times (\sqrt{5}-\sqrt{3})}} \cr
&= \dfrac{\sqrt{5}(\sqrt{3}-1)}{3 - 1} - \dfrac{\sqrt{3}(\sqrt{5}-\sqrt{3})}{5 - 3} \cr
&= \dfrac{\sqrt{15} - \sqrt{5}}{2} - \dfrac{\sqrt{15} - 3}{2} \cr
...
\begin{align*}
\dfrac{4}{1+\sqrt{2}+\sqrt{3}} &= \dfrac{4\hl{\times\left\\{ (1+\sqrt{2})-\sqrt{3}\right\\} }}{\left\\{ \big(1+\sqrt{2}\big)+\sqrt{3}\right\\} \hl{\times\left\\{ \big(1+\sqrt{2}\big)-\sqrt{3}\right\\} }} \cr
&= \frac{4\big(1 + \sqrt{2} - \sqrt{3}\big)}{\big(1+\sqrt{2}\big)^2 - \big(\sqrt{3}\big)^2} \cr
&= \frac{4\big(1 + \sqrt{2} - \sqrt{3}\big)}{1+2\sqrt{2}+2 - 3 } \cr
...
\begin{align*}
\cdots &= \frac{4\big(1 + \sqrt{2} - \sqrt{3}\big)\hl{\times \sqrt{2}}}{2\sqrt{2}\hl{\times \sqrt{2}}} \cr
&= \frac{\bcancel{4}(\sqrt{2} + 2 - \sqrt{6})}{\bcancel{4}} \cr
...
\begin{align*}
\dfrac{4}{1+\sqrt{2}+\sqrt{3}} &= \dfrac{4\hl{\times\left\\{ \big(1+\sqrt{3}\big)-\sqrt{2}\right\\} }}{\left\\{ \big(1+\sqrt{3}\big)+\sqrt{2}\right\\} \hl{\times\left\\{ \big(1+\sqrt{3}\big)-\sqrt{2}\right\\} }} \cr
&= \frac{4\big(1+\sqrt{3}-\sqrt{2}\big)}{\big(1+\sqrt{3}\big)^2 - \big(\sqrt{2}\big)^2} \cr
&= \frac{4\big(1+\sqrt{3}-\sqrt{2}\big)}{1+3+2\sqrt{3} - 2} \cr
&= \frac{4\big(1+\sqrt{3}-\sqrt{2}\big)}{2+ 2\sqrt{3}} \cr
&= \frac{2\big(1+\sqrt{3}-\sqrt{2}\big)}{\sqrt{3}+1} \cr
&= \frac{2\big(1+\sqrt{3}-\sqrt{2}\big)\hl{\times \big(\sqrt{3}-1\big)}}{\big(\sqrt{3}+1\big)\hl{\times \big(\sqrt{3}-1\big)}} \cr
&= \frac{2\big(1+\sqrt{3}-\sqrt{2}\big)\big(\sqrt{3}-1\big)}{3-1} \cr
&= \big(1+\sqrt{3}-\sqrt{2}\big)\big(\sqrt{3}-1\big) \cr
&= \sqrt{3} + 3 - \sqrt{6} - 1 - \sqrt{3} + \sqrt{2} \cr
&= \boldsymbol{ 2 + \sqrt{2} - \sqrt{6}. }
\end{align*}
...
{{% /mn %}}
\begin{align*}
& \dfrac{3\sqrt{2}}{2\sqrt{3}} - \dfrac{\sqrt{3}}{3\sqrt{2}} \cr
&= \dfrac{3\sqrt{2}\cdot \sqrt{3}}{2\sqrt{3}\cdot \sqrt{3}} - \dfrac{\sqrt{3}\cdot \sqrt{2}}{3\sqrt{2}\cdot \sqrt{2}} \tag{1} \cr
&= \dfrac{3\sqrt{6}}{6} - \dfrac{\sqrt{6}}{6} \cr
&= \dfrac{\bcancel{2}\sqrt{6}}{\bcancel{6}^3} \cr
...
\begin{align*}
& \dfrac{6}{3-\sqrt{7}} \cr
&= \dfrac{6\big(3+\sqrt{7}\big)}{\big(3-\sqrt{7}\big)\big(3+\sqrt{7}\big)} \tag{2} \cr
&= \dfrac{6\big(3+\sqrt{7}\big)}{9-7} \cr
&= \dfrac{\bcancel{6}^3\big(3+\sqrt{7}\big)}{\bcancel{2}} \cr
&= 3\big(3+\sqrt{7}\big) \cr
...
{{% /mn %}}
\begin{align*}
& \dfrac{\sqrt{3}-\sqrt{2}}{\sqrt{3}+\sqrt{2}} - \dfrac{\sqrt{5}+\sqrt{3}}{\sqrt{5}-\sqrt{3}} \cr
&= \dfrac{\big(\sqrt{3}-\sqrt{2}\big)^2}{\big(\sqrt{3}+\sqrt{2}\big)\big(\sqrt{3}-\sqrt{2}\big)} - \dfrac{\big(\sqrt{5}+\sqrt{3}\big)^2}{\big(\sqrt{5}-\sqrt{3}\big)\big(\sqrt{5}+\sqrt{3}\big)} \cr
&= \dfrac{3 - 2\sqrt{6} + 2}{3-2} - \dfrac{5 + 2\sqrt{15} + 3}{5-3} \cr
&= 5-2\sqrt{6} - \dfrac{8 + 2\sqrt{15}}{2} \tag{3} \cr
&= 5-2\sqrt{6} - \big(4 + \sqrt{15}\big) \cr
&= 5 - 2\sqrt{6} - 4 - \sqrt{15} \cr
...
\begin{align*}
\dfrac{1}{1+\sqrt{6}+\sqrt{7}} &= \dfrac{\big(1+\sqrt{6}\big)-\sqrt{7}}{\left\\{\big(1+\sqrt{6}\big)+\sqrt{7}\right\\}\left\\{\big(1+\sqrt{6}\big)-\sqrt{7}\right\\}} \cr
&= \dfrac{1+\sqrt{6}-\sqrt{7}}{\big(1+\sqrt{6}\big)^2 - 7} \cr
&= \dfrac{1+\sqrt{6}-\sqrt{7}}{1 + 2\sqrt{6} + 6 - 7} \cr
&= \dfrac{1+\sqrt{6}-\sqrt{7}}{ 2\sqrt{6}} \tag{4} \cr
&= \dfrac{\big(1+\sqrt{6}-\sqrt{7}\big)\cdot \sqrt{6}}{ 2\big(\sqrt{6}\big)^2} \cr
...
\begin{align*}
\dfrac{1}{5+2\sqrt{6}} &= \dfrac{5-2\sqrt{6}}{\big(5+2\sqrt{6}\big)\big(5-2\sqrt{6}\big)} \cr
&= \dfrac{5-2\sqrt{6}}{5^2 - \big(2\sqrt{6}\big)^2} \cr
&= \dfrac{5-2\sqrt{6}}{25-24} \cr
...
&= \tcirc{1} + \tcirc{2} \\\\[0.5em]
&= \dfrac{\sqrt{6} + 6 - \sqrt{42}}{12} + 5-2\sqrt{6} \cr
&= \dfrac{\sqrt{6} + 6 - \sqrt{42}}{12} + \dfrac{60 - 24\sqrt{6}}{12} \cr
...
{{% /mn %}}
\begin{align*}
& \dfrac{\sqrt{2}-\sqrt{3}+\sqrt{5}}{\sqrt{2}+\sqrt{3}-\sqrt{5}} \cr
&= \dfrac{\big\\{\sqrt{2}-\sqrt{3}+\sqrt{5}\big\\}\big\\{\big(\sqrt{2}+\sqrt{3}\big)+\sqrt{5}\big\\}}{\big\\{\big(\sqrt{2}+\sqrt{3}\big)-\sqrt{5}\big\\}\big\\{\big(\sqrt{2}+\sqrt{3}\big)+\sqrt{5}\big\\}} \cr
&= \dfrac{\big\\{\big(\sqrt{2}+\sqrt{5}\big)-\sqrt{3} \big\\}\big\\{\big(\sqrt{2}+\sqrt{5}\big)+\sqrt{3} \big\\}}{\big(\sqrt{2}+\sqrt{3}\big)^2 - 5} \tag{5} \cr
&= \dfrac{\big(\sqrt{2}+\sqrt{5}\big)^2 - 3}{2 + 2\sqrt{6} + 3 - 5} \cr
&= \dfrac{2 + 2\sqrt{10} + 5 - 3}{2\sqrt{6}} \cr
&= \dfrac{4 + 2\sqrt{10}}{2\sqrt{6}} \cr
&= \dfrac{2 + \sqrt{10}}{\sqrt{6}} \cr
&= \dfrac{\big(2 + \sqrt{10}\big)\cdot \sqrt{6}}{\big(\sqrt{6}\big)^2} \tag{6} \cr
&= \dfrac{2\sqrt{6} + 2\sqrt{15}}{6} \cr
...
{{% /mn %}}
\begin{align*}
&\dfrac{1}{\sqrt{3}} - \dfrac{1}{\sqrt{27}} \cr
&=
\dfrac{1}{\sqrt{3}} - \dfrac{1}{3\sqrt{3}} \tag{1} \cr
&= \dfrac{\sqrt{3}}{3} - \dfrac{\sqrt{3}}{9} \cr
&= \dfrac{3\sqrt{3}}{9} - \dfrac{\sqrt{3}}{9} \cr
&= \boldsymbol{ \dfrac{2\sqrt{3}}{9} }.
\end{align*}

{{% enum b %}}
\begin{align*}
&\dfrac{4}{3+\sqrt{5}} + \dfrac{1}{2+\sqrt{5}} \cr
&= \dfrac{4\big(3-\sqrt{5}\big)}{\big(3+\sqrt{5}\big)\big(3-\sqrt{5}\big)} + \dfrac{\sqrt{5}-2}{\big(2+\sqrt{5}\big)\big(\sqrt{5}-2\big)} \cr
&= \dfrac{4\big(3-\sqrt{5}\big)}{9-5} + \dfrac{\sqrt{5}-2}{5-4} \cr
&= 3-\sqrt{5} + \sqrt{5}-2 \cr
&= \boldsymbol{ 1 }.
\end{align*}
...
{{% enum a %}}
\begin{align*}
& \dfrac{8}{3+\sqrt{5}} + \dfrac{9}{\sqrt{7}+2} \cr
&= \dfrac{8\big(3-\sqrt{5}\big)}{\big(3+\sqrt{5}\big)\big(3-\sqrt{5}\big)} + \dfrac{9\big(\sqrt{7}-2\big)}{\big(\sqrt{7}+2\big)\big(\sqrt{7}-2\big)} \cr
&= \dfrac{8\big(3-\sqrt{5}\big)}{9 - 5} + \dfrac{9\big(\sqrt{7}-2\big)}{7 - 4} \cr
&= 2\big(3-\sqrt{5}\big) + 3\big(\sqrt{7}-2\big) \cr
&= 6 - 2\sqrt{5} + 3\sqrt{7} - 6 \cr
...
{{% /mn %}}
\begin{align*}
& \dfrac{1}{2}\left( \dfrac{2-\sqrt{3}}{2+\sqrt{3}} + \dfrac{2+\sqrt{3}}{2-\sqrt{3}}\right) \cr
&= \dfrac{1}{2}\left\\{ \dfrac{\big(2-\sqrt{3}\big)^2 + \big(2+\sqrt{3}\big)^2}{\big(2+\sqrt{3}\big)\big(2-\sqrt{3}\big)}\right\\} \cr
&= \dfrac{1}{2}\left\\{ \dfrac{2(4 + 3)}{4 - 3}\right\\} \tag{1} \cr
&= \dfrac{1}{2} \times 14 \cr
&= \boldsymbol{ 7 }.
\end{align*}
...
{{% /mn %}}
\begin{align*}
& \dfrac{\big(\sqrt{11}-\sqrt{2}+3\big)\big(\sqrt{11}+\sqrt{2}-3\big)}{3\sqrt{2}} \cr
&= \dfrac{\big\\{ \sqrt{11} + \big(3-\sqrt{2}\big) \big\\}\big\\{ \sqrt{11} - \big(3-\sqrt{2}\big) \big\\}}{3\sqrt{2}} \cr
&= \dfrac{ 11 - \big(3-\sqrt{2}\big)^2}{3\sqrt{2}} \tag{2} \cr
&= \dfrac{ 11 - 9 + 6\sqrt{2} - 2}{3\sqrt{2}} \cr
&= \dfrac{ 6\sqrt{2} }{3\sqrt{2}} \cr
&= \boldsymbol{ 2 }.
\end{align*}
