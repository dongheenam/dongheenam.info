...
{{% /mn %}}
`\begin{align*}
  \sqrt{1.21} &= \sqrt{\frac{121}{100}} \tag{1} \\
  &= \frac{11}{10} = \boldsymbol{ 1.1. }
\end{align*}`
{{% enum b %}}
`\begin{align*}
  \sqrt{0.0256} &= \sqrt{\frac{256}{10000}} \\
  &= \frac{16}{100} = \boldsymbol{ 0.16. }
\end{align*}`
{{% enum c %}}
`\begin{align*}
  \frac{\sqrt{12}\sqrt{20}}{\sqrt{15}} &= \sqrt{\frac{12\cdot \bcancel{20}^4}{\bcancel{15}^3}} \\
...
{{% /mn %}}
`\begin{align*}
  \sqrt{200}+\sqrt{98}-3\sqrt{72} &= \sqrt{2\cdot 10^2} + \sqrt{2 \cdot 7^2} - 3\sqrt{2 \cdot 6^2} \tag{1} \\
...
{{% /mn %}}
`\begin{align*}
  \sqrt{48}-\sqrt{27}+5\sqrt{12} &= \sqrt{3 \cdot 4^2} - \sqrt{3\cdot 3^2} + 5\sqrt{3 \cdot 2^2} \tag{2} \\
...
{{% /mn %}}
`\begin{align*}
  \big(1+\sqrt{3}\big)^3 &= 1 + 3\sqrt{3} + 3\sqrt{3}^2 + \sqrt{3}^3 \tag{3} \\
...
{{% /mn %}}
`\begin{align*}
  \big(2\sqrt{6}+\sqrt{3}\big)\big(\sqrt{6}-4\sqrt{3}\big) &= 2\cdot 6 + (-8+1)\sqrt{3}\sqrt{6} - 4\cdot 3 \tag{4} \\
  &= 12 - 7\sqrt{18} - 12 \\
  &= -7\sqrt{18} \\
...
{{% /mn %}}
`\begin{align*}
  & \big(1-\sqrt{7}+\sqrt{3}\big)\big(1+\sqrt{7}+\sqrt{3}\big) \\
...
{{% /mn %}}
`\begin{align*}
  & \big(\sqrt{2}-2\sqrt{3}-3\sqrt{6}\big)^2 \\
...
{{% /mn %}}
`\begin{align*}
  \frac{1}{\sqrt{3}-\sqrt{5}} &= \frac{\big(\sqrt{3}+\sqrt{5}\big)}{\big(\sqrt{3}-\sqrt{5}\big)\big(\sqrt{3}+\sqrt{5}\big)} \\
...
{{% /mn %}}
`\begin{align*}
  & \dfrac{\sqrt{3}}{1+\sqrt{6}}-\dfrac{\sqrt{2}}{4+\sqrt{6}} \\
...
{{% /mn %}}
`\begin{align*}
  & \dfrac{1}{\sqrt{2}+1}+\dfrac{1}{\sqrt{3}+\sqrt{2}}+\dfrac{1}{\sqrt{4}+\sqrt{3}}+\dfrac{1}{\sqrt{5}+\sqrt{4}} \tag{3} \\
...
{{% /mn %}}
`\begin{align*}
  \textstyle\sqrt{11+4\sqrt{6}} &= \textstyle\sqrt{11+2\sqrt{24}} \tag{1} \\
...
{{% /mn %}}
`\begin{align*}
  &\textstyle\sqrt{9+4\sqrt{4+2\sqrt{3}}} \\
  &= \textstyle\sqrt{9+4\sqrt{1+3+2\sqrt{\smash{1}\vphantom{3}}\sqrt{3}}} \\
  &= \textstyle\sqrt{9+4\sqrt{\big(1+\sqrt{3}\big)^2}} \\
  &= \textstyle\sqrt{9+4\big(1+\sqrt{3}\big)} \\
  &= \textstyle\sqrt{13+4\sqrt{3}} \\
  &= \textstyle\sqrt{13+2\sqrt{12}} \tag{1} \\
...
{{% /mn %}}
`\begin{align*}
  &\textstyle\sqrt{7-\sqrt{21+\sqrt{80}}} \\
...
{{% enum a %}}
`\begin{align*}
  a+\frac{1}{a} &= \frac{2}{3-\sqrt{5}} + \frac{3-\sqrt{5}}{2} \\
...
Then, because
`\begin{align*}
  &\left(a^3+\dfrac{1}{a^3}\right)\left(a^2+\dfrac{1}{a^2}\right) \\
  &= \hl{a^5} + a + \frac{1}{a} + \hl{\frac{1}{a^5}},
\end{align*}`

`\begin{align*}
  &a^5 + \frac{1}{a^5} \\
  &= \left(a^3+\dfrac{1}{a^3}\right)\left(a^2+\dfrac{1}{a^2}\right) - \left(a+\frac{1}{a}\right) \\
  &= 18\cdot 7 - 3 \\
  &= \boldsymbol{ 123 }.
\end{align*}`
