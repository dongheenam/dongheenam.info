...
{{% /mn %}}
`\begin{align*}
\dots &= \{ (\underline{x^2 + 5x}) + 4 \} \times \{ (\underline{x^2 + 5x}) + 6 \} - 24 \\
&= (\underline{x^2 + 5x})^2 + 10(\underline{x^2 + 5x}) + 24 - 24 \tag{1} \\
&= (x^2 + 5x)^2 + 10(x^2 + 5x) \\
&= \hl{(x^2 + 5x)}(x^2 + 5x + 10) \tag{2} \\
