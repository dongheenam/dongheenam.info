...
\begin{scope}[on behind layer]
    \draw [dashed, out=-110, in=110] (A) to node [fill=white] {5} (B);
    \draw [dashed, out=-15, in=195] (B) to node [fill=white] {10} (C);
    \draw [red, dashed, out=-60, in=60] (P) to node [fill=white] {$t$} (B);
    \draw [red, dashed, out=20, in=160] (Q) to node [fill=white] {$2t$} (C);
    \draw [red, dashed, out=5, in=140] (P) to node [fill=white] {$d(t)$} (Q);
\end{scope}
